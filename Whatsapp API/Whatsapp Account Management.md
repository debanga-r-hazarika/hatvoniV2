...
```json
{
  ...
  "info": {
    "version": "1.0.0",
    "title": "Get Phone Numbers with Filtering"
  },
  "servers": [
    {
      "url": "https://www.fast2sms.com"
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "schema": {
              "type": "string",
              "default": "id,is_official_business_account,display_phone_number,verified_name"
            },
            "required": true
          },
          {
            ...
            "schema": {
              "type": "string",
              "default": "[{'field':'account_mode','operator':'EQUAL','value':'SANDBOX'}]"
            },
            "required": false
          }
        ]
...
```json
{
  ...
  "paths": {
    "/dev/whatsapp/{version}/{phone-number_id}/whatsapp_business_profile": {
      "get": {
        "summary": "New Endpoint",
        "description": "This is your first endpoint! Edit this page to start documenting your API.",
        "operationId": "get_new-endpoint",
...
```json
{
  ...
  "paths": {
    "/dev/whatsapp/{version}/{phone_number_id}/whatsapp_business_profile": {
      "post": {
        "description": "",
        "operationId": "post_devwhatsapp{version}{phone_number_id}whatsapp_business_profile",
        "responses": {
          "200": {
            "description": ""
          }
...
```json
{
  ...
  "info": {
    "version": "1.0.0",
    "title": "Update Business Profile Photo"
  },
  "servers": [
    {
      "url": "https://www.fast2sms.com"
