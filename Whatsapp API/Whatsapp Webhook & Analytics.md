...
```json
{
  ...
  "paths": {
    "/dev/whatsapp/{REQUEST_ID}": {
      "get": {
        "description": "",
        "operationId": "get_devwhatsapp{request_id}",
        "responses": {
          "200": {
            "description": "",
            "content": {
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    ...
                    "message": {
                      "type": "string",
                      "default": "DLR found successfully."
                    },
                    "data": {
                      "type": "array",
                      "items": {
        ...
        "parameters": [
          {
            ...
            "required": true,
            "description": "Pass WhatsAprequest_id for which you're fetching delivery reports"
          },
          {
            "in": "query",
            "name": "authorization",
